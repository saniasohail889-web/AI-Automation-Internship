...
## Testing
Ten test cases are provided in `test-cases.md`. Test 1 was already observed successfully during development as an Account/Urgent/Negative/Support ticket and the urgent route was triggered. Tests 2–10 should be executed in n8n/Postman and their actual outputs should be recorded before final submission.
